...
async function mp_build(task) {
    ...
    //get cache here
    let currentMPCFG_Hash = await get_hash_cfg(mapart_build_cache.schematic);
    ...
    let sch = await schematic.loadFromFile(mapart_global_cfg.schematic_folder + mapart_build_cache.schematic.filename)
